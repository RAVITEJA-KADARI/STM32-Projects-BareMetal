 ...
 * @brief          : 16x2 LCD display demo using STM32F303 (bare metal)
 ******************************************************************************
 * @attention
 *
 * This project demonstrates register-level GPIO programming
 * on an STM32F303 microcontroller to drive a standard HD44780
 * 16x2 LCD in 8-bit mode without using HAL or CMSIS.
 * Using Bare-Metal Programing
