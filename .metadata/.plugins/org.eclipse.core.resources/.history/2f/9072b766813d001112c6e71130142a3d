...
int main(void)
{
  ...
  /* creation of LED1 */
  LED1Handle = osThreadNew(PE8, NULL, &LED1_attributes);

  /* creation of LED2 */
  LED2Handle = osThreadNew(PE10, NULL, &LED2_attributes);
...
/* USER CODE BEGIN Header_PE10 */
/**
* @brief Function implementing the LED2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_PE10 */
void PE10(void *argument)
{
  /* USER CODE BEGIN PE10 */
  /* Infinite loop */
  for(;;)
  {
