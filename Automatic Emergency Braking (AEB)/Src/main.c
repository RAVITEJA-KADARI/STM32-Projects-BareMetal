 ...
 * @brief          : IR Sensor Obstacle Detection with LCD, Buzzer, and Motor using STM32
 ******************************************************************************
 * @attention
 *
 * This project demonstrates bare-metal GPIO programming on STM32 microcontrollers 
 * to interface an IR sensor, control a buzzer and motor, and display obstacle 
 * detection status on a 16x2 LCD without using HAL or CMSIS libraries.
 *
 * Hardware  : STM32 Discovery Board, IR sensor, 16x2 LCD, Buzzer, DC Motor
 * Created   : 2026
 *
 * License   : MIT License
 *
